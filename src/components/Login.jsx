  ...
  return (
    <div className="bg-neutral-900 text-white">
      <div className="h-screen flex justify-center items-center">
        ...
        <div className={`w-[340px] duration-700 rounded-3xl p-4 backdrop-blur-sm ${scale ? "opacity-0 hidden" : "opacity-100"} h-3/4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[rgba(60,58,58,1)]`}>
