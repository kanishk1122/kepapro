...
const Watch = () => {
  ...
  return (
    <div style={bgImage}>
      <div  className="h-fit   " style={bgab} >
      <div  className={`bg-[rgba(0,0,0,0)] text-white w-full  `}  >
        <Navbar />
        <div className="h-fit px-2 justify-center items-center p-3 flex flex-wrap w-screen gap-3">
          <img src={Thumbnail} className="w-[300px] h-[400px] object-cover rounded-lg" alt="" />
        ...
        <div className="h-fit pb-5 w-full p-4 flex flex-wrap gap-4">
          ...
          <div className="w-[380px] bg-[rgb(0,0,0,0.7)] p-4 flex flex-col gap-2 rounded-lg">
        ...
        
           {
             ...
             {updatefromshow&&
              <form  onSubmit={updatevideohandler} className="w-full justify-center items-center m-4  h-fit p-6 flex flex-col gap-3    *:rounded-lg  px-14 rounded-lg  bg-transparent ">
                {/* 
      ...
      popular: req.body.populer, */}
        ...
        <div className="w-fit h-fit bg-transparent p-5 flex flex-wrap rounded gap-2">
          {/* {data.map((item, index) =>
            item.animename === name &&
            item.quality === 720 &&
      ...
      <div className="max-m:h-fit bg-transparent  flex flex-col gap-3 p-3 h-fit ">
        {/*{allcomment.map((item, index) => (
          <div key={index} className="w-fit h-fit flex gap-3 flex-wrap ">
            <div className="w-[50px] h-[50px] rounded-full overflow-hidden bg-transparent">
              <img
                src={item.image}
        ...
        <div className="w-full h-fit bg-transparent px-3 flex ">
          <form
            onSubmit={commenthandler}
            className="w-full h-fit flex bg-transparent flex-col gap-5 justify-end items-end"
          >
            <textarea
              value={comment}
