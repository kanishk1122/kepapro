...
const Adminreg = () => {
    ...
    const [verfiation ,setverfiation] = useState('')
  ...
  return (
    ...
    <form action="" className='flex flex-col w-1/2 gap-3 justify-center items-center p-6'>
        <input type="text" className='bg-transparent w-1/2 px-3'placeholder='enter here' onChange={(e)=>setverfiation(e.target.value)} />
    ...
    <input type="submit" className="bg-red-600 font-semibold px-2 py-1 rounded" onClick={() => setScale(!scale)} value={"Create an account"} />
